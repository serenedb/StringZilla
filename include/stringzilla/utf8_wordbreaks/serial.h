...
SZ_API_COMPTIME sz_u8_t sz_rune_word_break_property(sz_rune_t rune) {
    ...
    sz_size_t const range = sz_rune_range_find_(sz_utf8_word_break_astral_lo_, sz_utf8_word_break_astral_hi_,
                                                sz_utf8_word_break_astral_count_k, rune);
    return range != SZ_SIZE_MAX ? sz_utf8_word_break_astral_cls_[range] : (sz_u8_t)sz_utf8_word_break_other_k;
}
